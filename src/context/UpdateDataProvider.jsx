...
const UpdateDataProvider = ({ children }) => {
  ...
  const values = {
    ...
    skillToggle: (id, isEnable) => updateData("skill/enable", id, { isEnable }),
    projectUpdate: (id, data) => updateData("project", id, data),
    projectToggle: (id, isEnable) => updateData("project/enable", id, { isEnable }),
    serviceUpdate: (id, data) => updateData("service", id, data),
    serviceToggle: (id, isEnable) => updateData("service/enable", id, { isEnable }),
